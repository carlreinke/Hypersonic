        ...
        public static class GetAlbumList2OrderedByAlbumTitleAsyncTests
        {
            ...
            public static void GetAlbumList2OrderedByAlbumTitleAsync_NoAccessibleTrack_ReturnsNoAlbums()
            {
                ...
                using (var dbContext = new MediaInfoContext(dbContextOptionsBuilder.Options))
                {
                    ...
                    var results = RestApiQueries.GetAlbumList2OrderedByAlbumTitleAsync(dbContext, user.UserId, null, 0, 10, CancellationToken.None).GetAwaiter().GetResult();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasNonAccessibleTrack_TrackIsNotCounted()
            {
                var dbConnection = OpenSqliteDatabase();
