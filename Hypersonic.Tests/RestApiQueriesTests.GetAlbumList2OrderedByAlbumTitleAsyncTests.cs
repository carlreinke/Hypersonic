...
namespace Hypersonic.Tests
{
    ...
    {
        public static class GetAlbumList2OrderedByAlbumTitleAsyncTests
        {
            ...
            [InlineData(5, 10)]
            [InlineData(10, 5)]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_VariousOffsetAndCount_ReturnsExpectedAlbumDetails(int albumCount, int count)
            {
                var dbConnection = OpenSqliteDatabase();
                ...
                using (var dbContext = new MediaInfoContext(dbContextOptionsBuilder.Options))
                {
                    ...
                    for (int i = 0; i <= albumCount; ++i)
                    {
                        var result = RestApiQueries.GetAlbumList2OrderedByAlbumTitleAsync(dbContext, user.UserId, null, i, count, CancellationToken.None).GetAwaiter().GetResult();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumIsPlaceholder_AlbumIsNotReturned()
            {
                var dbConnection = OpenSqliteDatabase();
                ...
                using (var dbContext = new MediaInfoContext(dbContextOptionsBuilder.Options))
                {
                    ...
                    var result = RestApiQueries.GetAlbumList2OrderedByAlbumTitleAsync(dbContext, user.UserId, null, 0, 10, CancellationToken.None).GetAwaiter().GetResult();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumArtistIsPlaceholder_ReturnsPlacholderName()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_NoAccessibleTrack_ReturnsNoAlbums()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasNoAccessibleTrack_AlbumIsNotReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasInaccessibleTrack_TrackIsNotCounted()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasAccessibleAccessControlledTrack_AlbumIsReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasAccessibleNonAccessControlledTrack_AlbumIsReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasNoStar_StarredHasNoValue()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasStar_StarredHasExpectedValue()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasNoDate_YearIsNotReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasDate_YearIsReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasNoGenre_GenreIsNotReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_AlbumHasGenre_GenreIsReturned()
            {
                var dbConnection = OpenSqliteDatabase();
            ...
            [Fact]
            public static void GetAlbumList2OrderedByAlbumTitleAsync_Always_AlbumsAreInExpectedOrder()
            {
                var dbConnection = OpenSqliteDatabase();
                ...
                using (var dbContext = new MediaInfoContext(dbContextOptionsBuilder.Options))
                {
                    ...
                    var result = RestApiQueries.GetAlbumList2OrderedByAlbumTitleAsync(dbContext, user.UserId, null, 0, albums.Count, CancellationToken.None).GetAwaiter().GetResult();
